package com.ajouton.noname.domain.s3;
...
public class AmazonS3Service {
    ...
    public void deleteImages(List<Object> imgOptions){

        for(Object imgOption:imgOptions){
            //TODO: 이미지가 저장된 곳에서 url 꺼내서 deleteImage()에 넣어주기
            deleteImage("test");
        }
    }
